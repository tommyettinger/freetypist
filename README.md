...
Versions here are linked to TextraTypist versions, so version `2.5.0.0` uses TextraTypist `2.5.0`, with a bugfix or
...
`2.5.1`, then the corresponding version of FreeTypist would be `2.5.1.0`.
