...
Versions here are linked to TextraTypist versions, so version `2.0.2.0` uses TextraTypist `2.0.2`, with a bugfix or
...
```gradle
implementation 'com.github.tommyettinger:freetypist:2.0.2.0'
```
