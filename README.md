...
Versions here are linked to TextraTypist versions, so version `2.4.4.0` uses TextraTypist `2.4.4`, with a bugfix or
...
`2.4.5`, then the corresponding version of FreeTypist would be `2.4.5.0`.
