...
Versions here are linked to TextraTypist versions, so version `2.1.5.0` uses TextraTypist `2.1.5`, with a bugfix or
...
`2.1.6`, then the corresponding version of FreeTypist would be `2.1.6.0`.
