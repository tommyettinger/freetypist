...
Versions here are linked to TextraTypist versions, so version `2.4.2.0` uses TextraTypist `2.4.2`, with a bugfix or
...
`2.4.3`, then the corresponding version of FreeTypist would be `2.4.3.0`.

# Dependency

Using JitPack for stable releases:

```gradle
implementation 'com.github.tommyettinger:freetypist:2.4.2.0'
```

Using JitPack for a specific commit:
