...
Versions here are linked to TextraTypist versions, so version `2.2.3.0` uses TextraTypist `2.2.3`, with a bugfix or
...
`2.2.4`, then the corresponding version of FreeTypist would be `2.2.4.0`.
