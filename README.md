...
Versions here are linked to TextraTypist versions, so version `2.2.10.0` uses TextraTypist `2.2.10`, with a bugfix or
...
`2.2.11`, then the corresponding version of FreeTypist would be `2.2.11.0`.
