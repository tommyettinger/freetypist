...
Versions here are linked to TextraTypist versions, so version `2.1.2.0` uses TextraTypist `2.1.2`, with a bugfix or
...
`2.1.3`, then the corresponding version of FreeTypist would be `2.1.3.0`.
