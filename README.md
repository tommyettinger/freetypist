...
Versions here are linked to TextraTypist versions, so version `2.2.15.0` uses TextraTypist `2.2.15`, with a bugfix or
...
`2.2.16`, then the corresponding version of FreeTypist would be `2.2.16.0`.
...
```gradle
implementation 'com.github.tommyettinger:freetypist:2.2.15.0'
```
