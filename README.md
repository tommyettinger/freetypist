...
Versions here are linked to TextraTypist versions, so version `2.2.12.0` uses TextraTypist `2.2.12`, with a bugfix or
...
`2.2.13`, then the corresponding version of FreeTypist would be `2.2.13.0`.
...
```gradle
implementation 'com.github.tommyettinger:freetypist:2.2.12.0'
```
